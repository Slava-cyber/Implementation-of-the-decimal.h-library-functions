...
START_TEST(s21_add_1) {
  ...
  int res = 0;
  s21_decimal s21_res = s21_add(src1, src2);
...
int main() {
  ...
  tcase_add_test(s21_decimal_tests3, s21_add_1);
  tcase_add_test(s21_decimal_tests3, s21_add_2);
  tcase_add_test(s21_decimal_tests3, s21_add_3);
  tcase_add_test(s21_decimal_tests3, s21_add_4);
  tcase_add_test(s21_decimal_tests3, s21_div_1);
  tcase_add_test(s21_decimal_tests3, s21_div_2);
  tcase_add_test(s21_decimal_tests3, s21_mod_1);
  tcase_add_test(s21_decimal_tests3, s21_mod_2);
  tcase_add_test(s21_decimal_tests3, s21_mul_1);
  tcase_add_test(s21_decimal_tests3, s21_mul_2);
